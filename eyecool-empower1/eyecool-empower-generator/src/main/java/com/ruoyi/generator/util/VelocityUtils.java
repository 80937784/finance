...
public class VelocityUtils {
     ...
     * @return 模板列表
     */
    public static List<String> getTemplateList(String tplCategory, String xmlVmFilePath, String sqlVmFilePath) {
        ...
        templates.add(StringUtils.isBlank(xmlVmFilePath) ? "vm/xml/mapper.xml.vm" : xmlVmFilePath);
        ...
        templates.add(StringUtils.isBlank(sqlVmFilePath) ? "vm/sql/sql.vm" : sqlVmFilePath);
        return templates;
    }
