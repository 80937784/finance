...
public class GenTableServiceImpl implements IGenTableService {
    ...
    public Map<String, String> previewCode(Long tableId) {
        ...
        if (DatabaseTypeConstants.DB_ORACLE.equals(databaseId)) {
            templates = VelocityUtils.getTemplateList(table.getTplCategory(), "vm/oracle/xml/mapper.xml.vm", "vm/oracle/sql/sql.vm");
        } else if (DatabaseTypeConstants.DB_MYSQL.equals(databaseId)) {
            templates = VelocityUtils.getTemplateList(table.getTplCategory(), null, null);
        } else {
            throw new BusinessException("unsupported database type, databaseId = " + databaseId);
        }
    ...
    private void generatorCode(String tableName, ZipOutputStream zip) {
        ...
        if (DatabaseTypeConstants.DB_ORACLE.equals(databaseId)) {// oracle数据库通过序列生成id
