...
public class QRCodeUtil {
     ...
     *  needCompress:"true"表示将嵌入二维码的图片进行压缩，如果为"false"则表示不压缩。
     */
    ...
    // 被注释的方法
    /*
     * public static void encode(String content, String destPath, boolean needCompress) throws Exception { QRCodeUtil.encode(content, null, destPath, needCompress); }
     */
