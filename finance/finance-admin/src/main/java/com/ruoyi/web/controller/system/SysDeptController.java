...
public class SysDeptController extends BaseController {
    ...
    public AjaxResult addSave(@Validated SysDept dept) {
        ...
        if (null != parentDept && SysConfigConstants.DEFAULT_SYS_DEPT_CODE.equals(parentDept.getDeptCode())) {
            return error("上级部门不能是默认部门");
        }
    ...
    public AjaxResult remove(@PathVariable("deptId") Long deptId) {
        ...
        if (null != sysDept && SysConfigConstants.DEFAULT_SYS_DEPT_CODE.equals(sysDept.getDeptCode())) {
            return AjaxResult.warn("默认部门不允许删除");
        }
